...
insert into Bank_Inventory(Product,Quantity,Price,purcahase_cost,estimated_sale_price) values('DailCard',2,380.00,8500.87,9900.00);
...
select * from bank_inventory;
delete from bank_inventory where (estimated_sale_price-purcahase_cost) < 0.05 * estimated_sale_price;
...
insert into Bank_Holidays(Holiday,Start_time,End_time) values('2020-03-20',curdate(),curdate());
